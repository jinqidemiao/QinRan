...
public class JwtHelper {
    ...
    public static void addToCookie(HttpServletResponse response, String token) throws UnsupportedEncodingException {
    ...
    public static String validateLogin(String jsonWebToken) {
        ...
        if (claims != null) {
            ...
            //刷新JWT
            retMap.put("freshToken", generateJWT(decryptUserId, (String) claims.get("userName"),(String) claims.get("source"), (String) claims.get("userAgent"), (String) claims.get("domainName")));
        } else {
